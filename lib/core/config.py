...
# Horizontal flip vertical at the original scale (id transform)
__C.TEST.BBOX_AUG.V_FLIP = False

# Horizontal rotation 90 at the original scale (id transform)
__C.TEST.BBOX_AUG.ROTATION90 = False
...
# Vertical flip at each scale
__C.TEST.BBOX_AUG.SCALE_V_FLIP = False

# Rotation 90 at each scale
__C.TEST.BBOX_AUG.SCALE_ROTATION90 = False
