...
DATASETS = {
    ...
    'gangjin_train': {
        IM_DIR:
            _DATA_DIR + '/gangjin/images/test',
        ANN_FN:
            _DATA_DIR + '/gangjin/annotations/instances_train.json',
    },
    'gangjin_val': {
        IM_DIR:
            _DATA_DIR + '/gangjin/images/val',
        ANN_FN:
            _DATA_DIR + '/gangjin/annotations/instances_val.json',
    }
}
